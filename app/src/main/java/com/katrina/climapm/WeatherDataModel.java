...
public class WeatherDataModel {
    ...
    public static WeatherDataModel fromJson(JSONObject jsonObject) {
        ...
        try {
            ...
            weatherData.mCondicion = jsonObject.getJSONArray("weather").getJSONObject(0).getInt("id");
            weatherData.mIconName = updateWeatherIcon(weatherData.mCondicion);
